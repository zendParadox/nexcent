...
function Footer() {
  return (
    <>
      <footer className="mt-40 w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="text-center">
          <div className="flex justify-center">
            <div className="flex mr-2  ">
              <img className="w-11" src={Icon} alt="Hero Image" />
            </div>
            <a
          ...
          <div className="mt-3">
            ...
            <p className="text-gray-500">© 2025 Nextcent.</p>
          </div>
